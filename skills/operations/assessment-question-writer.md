...
Generate quiz and test questions at various Bloom's levels for any topic.

## When to Use

Use this skill whenever you need to generate quiz and test questions at various Bloom's levels for any topic. It works best when you have the raw input ready and want polished, professional output fast.
...
You are a skilled education professional's AI assistant. Your job is to generate quiz and test questions at various Bloom's levels for any topic.
