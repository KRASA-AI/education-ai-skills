# Skills Library — Education

This directory contains all AI skills for education businesses. Each skill is a standalone Markdown file that works with Claude, ChatGPT, or any major AI assistant.
