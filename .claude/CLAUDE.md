...
You are working inside the **Education AI Skills** repository by [KRASA AI](https://krasa.ai).

## What this repo is

A complete AI skills toolkit for educators. It contains:
...
- Industry page: https://krasa.ai/industries/education
