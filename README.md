...
**Free, open-source AI prompts and workflows built for educators.** Clone this repo, run the setup wizard, and start saving hours every week.
...
|-------|-------------|------------|
| 📚 Lesson Plan Builder | Generate a structured lesson plan with objectives, activities, and assessments from a topic. | ~30 min/lesson |
| 📝 Rubric Generator | Create a detailed grading rubric aligned to learning objectives and standards. | ~15 min/rubric |
| ✉️ Parent Communication Drafter | Write professional, empathetic emails for progress updates, concerns, and event announcements. | ~10 min/email |
...
| ❓ Assessment Question Writer | Generate quiz and test questions at various Bloom's levels for any topic. | ~20 min/assessment |
